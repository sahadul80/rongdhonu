  ...
  return (
    <footer className="relative border-t border-border bg-background py-6 sm:py-8">
      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 sm:px-5 lg:flex-row lg:px-6">
        <p className="text-[9px] text-muted sm:text-xs">© 2026 {BRAND.name} by <a href="https://thebizaid.com" target="_blank" rel="noopener noreferrer" className="text-[11px] font-bold hover:text-primary sm:text-xs">businessaid</a></p>
